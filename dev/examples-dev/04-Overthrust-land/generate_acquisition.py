...
vp_true = np.loadtxt('./acquisition/Overthrust_501_151_20m.dat')
...
## set gradient mask for FWI (1: keep gradient; 0: mute gradient)
# For land acquisition, we can use the default gradient damping mask generated by code 
# instead of using the following hard mute mask (set all gradients to zero).
...
files = ['./acquisition/vp_true.npy', './acquisition/rho_true.npy', 
         ...
         './acquisition/src_coord.npy', './acquisition/wavelets.npy', 
         './acquisition/rec_coord.npz']
