...
from tools import saveparjson


### system setup
modelpath = '/data/haipeng/SWIT-1.0/examples/case-03-marmousi2-traveltime/model/'        # Model path, i.e., velocity, source & receiver coordinates
homepath  = '/data/haipeng/SWIT-1.0/examples/case-03-marmousi2-traveltime/traveltime/'   # Working path
...
# initial model
vp_init = np.loadtxt(modelpath + 'Marmousi_481_121_25m_1d.dat')
...
### inversion parameter
misfit_type = 'Traveltime'                         # 'Traveltime', 'Waveform', 'Globalcorrelation'
scheme      = 'NLCG'                               # 'NLCG', 'LBFGS'
maxiter     = 30                                   # maximum iteration number,  i.e., 20
...
grad_smooth = 20                                   # gradient smooth radius 
...
mute_late_window = 0.3                             # mute time window (units: time)
...
# data normalize
normalize = ['Max-Trace']                          # 'Max-Trace', 'L1-Trace', 'L2-Trace', 'L1-Event', 'L2-Event', 'None'
