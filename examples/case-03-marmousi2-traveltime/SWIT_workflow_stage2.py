...
from tools import saveparjson, loadbinfloat32, smooth2d
...
homepath  = '/data/haipeng/SWIT-1.0/examples/case-03-marmousi2-traveltime/globalcorrelation/'   # Working path
...
# initial model
vp_init = loadbinfloat32('/data/haipeng/SWIT-1.0/examples/case-03-marmousi2-traveltime/traveltime/outputs/velocity/vp-30.bin').reshape((nx, nz))
