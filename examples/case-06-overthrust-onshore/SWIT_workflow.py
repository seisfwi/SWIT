...
### system setup
modelpath = '/data/haipeng/SWIT-1.0/examples/case-06-overthrust-onshore/model/'   # Model path, i.e., velocity, source & receiver coordinates
homepath  = '/data/haipeng/SWIT-1.0/examples/case-06-overthrust-onshore/'         # Working path
...
# true model
vp_true = np.loadtxt(modelpath + 'Overthrust_501_151_20m.dat')

# initial model
vp_init = np.copy(vp_true)
vp_init = smooth2d(vp_true, span = 20)
np.savetxt(modelpath + 'Overthrust_501_151_20m_smooth20.dat', vp_init)
...
vpmin       = 2000                                 # minimum allowed velocity
