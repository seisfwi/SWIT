...
### system setup
modelpath = '/data/haipeng/SWIT-1.0/examples/case-08-checkboard/model/'   # Model path, i.e., velocity, source & receiver coordinates
homepath  = '/data/haipeng/SWIT-1.0/examples/case-08-checkboard/'         # Working path
...
# true model
vp_true = np.loadtxt(modelpath + 'checkboard_401_101_25m.dat')

# initial model
vp_init = np.copy(vp_true)
vp_init = smooth2d(vp_true, span = 20)
np.savetxt(modelpath + 'background_401_101_25m.dat', vp_init)
...
vpmax       = 4000                                 # maximum allowed velocity
vpmin       = 3000                                 # minimum allowed velocity
