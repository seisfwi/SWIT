...
your_data = np.loadtxt('shot020.dat')
your_recx = np.loadtxt('shot020_recx.dat')
...
recx_in_swit = np.linspace(rec_x_beg, rec_x_end, recn_in_swit)
...
for irec in range(your_recn):
    ...
    traces[itrace].data = your_data[:, itrace]
