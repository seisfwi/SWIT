...
### system setup
homepath  = '/data1/SWIT/case5-marmousi-land-1D-model/stage1-traveltime/'   # working path
...
# true model
model_folder = '/home/haipeng/Nutstore Files/Nutstore/MyCodes/SWIT-1.0/examples/case5-marmousi-land-1D-model/'
vp_true = np.loadtxt(model_folder + 'model/Marmousi_481_121_25m_True.dat')

# initial model
vp_init = np.loadtxt(model_folder + 'model/Marmousi_481_121_25m_1d.dat')
...
mute_late_window = 0.4                             # mute time window (units: time)
