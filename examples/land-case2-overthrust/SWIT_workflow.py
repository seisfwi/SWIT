...
### system setup
homepath  = '/data/haipeng/SWIT-1.0/examples/land-case2-overthrust/'   # working path
mpiproc   = 31                                     # mpi process for fd2dmpi
...
# true model
vp_true = np.loadtxt(homepath + 'model/Overthrust_401_101_25m_True.dat')

# initial model
vp_init = smooth2d(vp_true, span = 20)
np.savetxt(homepath + 'model/Overthrust_401_101_25m_True_smooth_20.dat', vp_init)
...
vpmin       = 2200                                 # minimum allowed velocity
