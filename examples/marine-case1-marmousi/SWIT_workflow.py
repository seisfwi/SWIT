...
### system setup
homepath  = '/data/haipeng/SWIT-1.0/examples/marine-case1-marmousi/'   # working path
...
# true model
vp_true = np.loadtxt(homepath + 'model/Marmousi_481_141_25m_True.dat')

# initial model
vp_init = np.copy(vp_true)
vp_init[:,20:] = smooth2d(vp_true[:,20:], span = 20)
np.savetxt(homepath + 'model/Marmousi_481_141_25m_True_smooth_20.dat', vp_init)
