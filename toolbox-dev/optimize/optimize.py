...
class Optimize(object):
    ...
    def __init__(self, niter_max = 1000, conv = 1e-8, method = 'SD', bound = False, lb = None, ub = None, lbfgs_memory = 20, debug = False):
        
        self.niter_max = niter_max
        self.conv  = conv
        self.method= method              #### Optimization method: SD, PNLCG, LBFGS, PLBFGS, TRN, PTRN
        self.bound = bound               #### Bound constraints option
        self.lb    = lb                  #### Lower boundary 
        self.ub    = ub                  #### Upper boundary
        self.debug = debug               #### Debug option FOR USER
    ...
    def print_info(self, fcost):
        ''' Print information
        '''
        print_info(self, fcost)


    def print_info_TRN(self, fcost):
        ''' Print information
        '''
        print_info_TRN(self, fcost)


    def print_info_PTRN(self, fcost):
        ''' Print information
        '''
        print_info_PTRN(self, fcost)
